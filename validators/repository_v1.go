...
type V1ValidatorsRepositoryConfig struct {
	HubContract       string
	NetworkGeneration string
}

func NewV1ValidatorsRepository(cfg *V1ValidatorsRepositoryConfig, apiClient *client.TerraRESTApis) *V1ValidatorsRepository {
